...
def build_deep_network(linear_dimensions):
    ...
    hidden_1_to_hidden_2 = FullConnection(hiddenLayer_1, outLayer)
    ...
    # neural_net.addConnection(FullConnection(biasUnit, hiddenLayer_3))
...
# load data
train_data1 = np.loadtxt(train_file, delimiter=',')
...
validation_data1 = np.loadtxt(validation_file, delimiter=',')
...
learner_net = train(train_data, labels, custom_net=None, training_mse_threshold=threshold, epoch_threshold=20,
                    epochs=10)
